...
public class BoardDto {
	...
	public BoardDto(int board_no, String board_category, String board_id, String board_title, String board_content,
			Date board_date, String board_views, String board_secret, int board_price, int board_prodno, int board_groupno, int board_group, int member_no) {
	...
	public String toString() {
		return "BoardDto [board_no=" + board_no + ", board_category=" + board_category + ", board_id=" + board_id
				+ ", board_title=" + board_title + ", board_content=" + board_content + ", board_date=" + board_date
				+ ", board_views=" + board_views + ", board_secret=" + board_secret + ", board_price=" + board_price
				+ ", board_prodno=" + board_prodno + ", board_groupno=" + board_groupno + ", board_group=" + board_group
				+ ", member_no=" + member_no + ", replycount=" + replycount + "]";
	}
