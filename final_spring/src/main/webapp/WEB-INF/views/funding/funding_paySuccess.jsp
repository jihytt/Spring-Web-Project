                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #d5e5a3;">
                                <tbody><tr>
                                    <td class="content-block"> 
                                      <em style="font-style:normal; font-size:22px;font-weight:bold; white-space: nowrap; overflow: hidden;float left">${dto.member_id }님, 펀딩에 참여해주셔서 감사합니다.</em>
                                ...
                                <tr>
                                    <td class="content-block">
                                        <a style="text-decoration: none; color: #1AAB8A;" href="funding_paycancel.do?merchant_uid=${paymentdto.merchant_uid}&funding_no=${fundingdto.funding_no }&pay_count=${paymentdto.pay_count}&pay_price=${paymentdto.pay_price}">환불하기</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
