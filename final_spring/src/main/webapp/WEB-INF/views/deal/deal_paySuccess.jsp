                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #d5e5a3;">
                                <tbody><tr>
                                    <td class="content-block">
                                        <h2 style="font-size:23px;">${dto.member_id }님의 거래가 완료되었습니다.</h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                            ...
                                            <tr>
                                                <td>
                                                    <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                        <tbody style="background-color: #d5e5a3;"><tr>
                                                            <td>거래 제목</td>
                                                            <td class="alignright" style="  white-space: nowrap; overflow: hidden; ">${dealDto.board_title }</td>
                                                        </tr>
                                                       
                                                        <tr>
                                                            <td>거래 금액</td>
                                                            <td class="alignright"> ${dealDto.board_price }</td>
                                                        </tr>
                                                        <tr class="total">
                                ...
                                <tr>
                                   <td class="content-block">
                                        <a style="text-decoration: none; color: #1AAB8A;" href="dealList.do">다른거래 둘러보기</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
